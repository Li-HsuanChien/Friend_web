...
<a href="http://localhost:3000/verify/{}">Click here to verify your email</a>""".format(str(token_id))
                    }
            ]
    }
...
<a href="http://localhost:3000/reset-password/{}">Click here to reset your password</a>""".format(str(token_id))
                    }
            ]
    }
    result = mailjet.send.create(data=data)
